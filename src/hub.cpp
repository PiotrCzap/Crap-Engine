...
void Create_Project_window(void)
{
...
void Project_window(void)
{
    ...
    Engine_draw_rectangle_shape_with_texture(settings_icon, 195.0f, 4.0f, 50.0f, 50.0f, 0.0f, WHITE);
    ...
    if (tabs == 1)
    {
        ...
        Engine_button(Create_Project_window, "NEW PROJECT", 580.0f, 10.0f, 591.5f, 20.0f, 200.0f, 40.0f);
    }
